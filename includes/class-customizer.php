<?php
/**
 * Completely removes the Customizer, as in
 * 99.9% of cases its not used
 */
class AnunaPress_Customizer_Remove_All {
    /**
     * @var AnunaPress_Customizer_Remove_All
     */
    private static $instance;
    /**
     * Main Instance
     *
     * Allows only one instance of AnunaPress_Customizer_Remove_All in memory.
     *
     * @static
     * @staticvar array $instance
     * @return Big mama, AnunaPress_Customizer_Remove_All
     */
    public static function instance() {
        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof AnunaPress_Customizer_Remove_All ) ) {
            // Start your engines!
            self::$instance = new AnunaPress_Customizer_Remove_All;
...
AnunaPress_Customizer_Remove_All::instance();
